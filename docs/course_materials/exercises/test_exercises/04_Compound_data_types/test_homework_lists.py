...
def test_lists(helpers):
    ...
    helpers.tests_list = [
        ...
        [r"""^list.*\s*=\s*\[\]""", "1.1. Expected the list to be set by using `= []`"],
        [
            r"""^list.*\s*=\s*list\(\)""",
        ...
        [r"""l1\.index\(6\)""", "1.3. Expected the use of list.index()"],
        [r".*?\b4\b(.*[^\]])?$", "1.3. Index of number 6 is incorrect"],
        ...
        [r".*?\b7\b(.*[^\]])?$", "1.5. Make sure to print out the length of l1"],
        ...
        [r"\[4, 5\]", "2.3. Expected the print of the 2 middle numbers"],
        ...
        [r"print\(.*l2.*\)", "3.2. Expected a print out of l2 list"],
        ...
        [r"""(print\()?.*\blen\(l1\).*\)?""", "3.5. Expected the use of len(list)"],
        [r".*?\b6\b(.*[^\]])?$", "3.5. len of l1 should be 6"],
        [r".*?\b3\b(.*[^\]])?$", "3.5. len of l2 should be 3"],
        [r".*?\b9\b(.*[^\]])?$", "3.5. len of l3 should be 9"],
    ]
