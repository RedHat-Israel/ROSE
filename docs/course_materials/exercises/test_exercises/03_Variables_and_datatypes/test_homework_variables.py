...
def test_variables_2(helpers):
    ...
    helpers.tests_list = [
        ...
        [r"\D*30\D*", error_message + f"the expected multiplication answer is {30}"],
        [r"\D*7\D*", error_message + f"the expected subtraction answer is {7}"],
        [
            r"\D*" + str(10 / 3) + r"\D*",
            error_message + f"the expected devision answer is {10/3}",
        ],
        [r"\D*1\D*", error_message + f"the expected modulo answer is {1}"],
    ]
