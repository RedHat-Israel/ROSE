...
def create_invitation(service, args, invite_type):
    """
    Uses:
    - service - connection to google class.
    - args - for list path and class ID.
        ...
        for mail in mail_list:
            ...
            try:
                ...
                if '409' in str(e):
                    ...
                    print(f'Not added, {mail} already listed in class.')
                else:
                    print('No permissions or wrong class ID.')
