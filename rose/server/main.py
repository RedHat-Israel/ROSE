...
def main():
    ...
    """
    If the argument is 'same', the track will generate the obstacles
    in the same place for both drivers.
    Otherwise, the obstacles will be generated in random locations
    for each driver.
    """
