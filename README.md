...
This project is a game that has been developed to assist in teaching children python.
...
then calculate the best path to take to avoid the pitfalls; and finally, collect bonus points.
